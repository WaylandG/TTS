...
/** 传回点击的Button */
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToButton:(UIButton*)button;
...
/** block方式监听点击 */
@property (nonatomic, copy) void (^buttonDidScrollOperationBlock)(UIButton* button);
