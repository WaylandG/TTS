...
/** 默认的列数 */
static const NSInteger WKDefaultColumnCount = 2;
/** 默认的每一列间距 */
static const NSInteger WKDefaultColumnMargin = 2;
/** 默认的每一行间距 */
static const NSInteger WKDefaultRowMargin = 2;
/** 边缘间距 */
static const UIEdgeInsets WKDefaultEdgeInsets = {2,2,2,2};
...
//    _attributeArray = [NSMutableArray array];
    ...
    [self.attsArray addObject:layoutHeader];
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(WKWaterViewLayout*)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section{
